...
namespace MMO_Server.Migrations
{
    ...
    [Migration("20220704124445_Equipped")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMO_Server.DB.AccountDb", b =>
                {
            ...
            modelBuilder.Entity("MMO_Server.DB.ItemDb", b =>
                {
            ...
            modelBuilder.Entity("MMO_Server.DB.PlayerDb", b =>
                {
            ...
            modelBuilder.Entity("MMO_Server.DB.ItemDb", b =>
                {
                    b.HasOne("MMO_Server.DB.PlayerDb", "Owner")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("MMO_Server.DB.PlayerDb", b =>
                {
                    b.HasOne("MMO_Server.DB.AccountDb", "Account")
                        .WithMany("Players")
