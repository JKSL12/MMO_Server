...
namespace MMO_Server.Game
{
    ...
    public class Map
    {
        ...
        public bool CanGo(Vector2Int cellPos, bool checkObjects = true)
        {
            ...
            return _collision[y, x] == 0 && (!checkObjects || _objects[y, x] == null);
        }

        public bool Warp(Vector2Int cellPos, bool checkObjects = true)
        {            
            if (cellPos.x < MinX || cellPos.x > MaxX)
                return false;
            if (cellPos.y < MinY || cellPos.y > MaxY)
            ...
            return _collision[y, x] == 2;// && (!checkObjects || _objects[y, x] == null);
        }
        ...
        {         
           // if (ApplyLeave(gameObject) == false) return false;
