    ...
    public class GameLogic : JobSerializer
    {
       ...
       // object _lock = new object();
        ...
        public void Update()
        {
            ...
            ObjectManager.Instance.PlayerUpdate();
        ...
        public GameRoom Add(MapData mapData)
        {
            GameRoom gameRoom = new GameRoom();
            //gameRoom.Init(mapId);
            //gameRoom.Push(gameRoom.Init, mapData, 10);
            gameRoom.Init(mapData, 10);

            //lock(_lock)
            {
                gameRoom.RoomId = mapData.id;
                DataManager.MonsterSpawnDict.TryGetValue(gameRoom.RoomId, out gameRoom.monsterSpawnData);
                _rooms.Add(_roomId, gameRoom);
                _roomId++;
            }
